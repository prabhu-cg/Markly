...
### 📥 Input Methods
- **Drag & Drop** — Drop `.docx`, `.txt`, `.md`, or `.json` files anywhere
...
- **JSON Support** — Full JSON input with three output modes
...
#### JSON Output Modes
- **Readable Mode** — Structured text with headings, lists, and visual grouping
- **Table Mode** — Converts arrays of objects into HTML tables with GFM support
- **Code Mode** — Pretty-printed JSON in syntax-highlighted code blocks

### 🌓 Theme Support
- **Dark/Light Mode** — Full theme support with toggle button
- **Persistent Preference** — Theme choice saved to localStorage
- **Professional Styling** — Consistent colors across all output modes
- **GFM Tables** — GitHub Flavored Markdown table support for structured data
- **About Modal** — Quick access to app information and features
